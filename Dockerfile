...
RUN echo 'export LLVM_SYMBOLIZER_PATH=/usr/bin/llvm-symbolizer' | tee -a /home/vscode/.bashrc ~/.bashrc
...
RUN echo 'export PATH="/home/vscode/.modular/pkg/packages.modular.com_mojo/bin:$PATH"' >> ~/.bashrc
